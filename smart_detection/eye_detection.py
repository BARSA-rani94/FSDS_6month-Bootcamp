...
face_cascade = cv2.CascadeClassifier(r"C:\Users\HP\Downloads\New folder\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"C:\Users\HP\Downloads\New folder\haarcascade_eye.xml")
# Load the image

img = cv2.imread(r"C:\Users\HP\OneDrive\Desktop\training\Happy_faces\3.jpeg")
